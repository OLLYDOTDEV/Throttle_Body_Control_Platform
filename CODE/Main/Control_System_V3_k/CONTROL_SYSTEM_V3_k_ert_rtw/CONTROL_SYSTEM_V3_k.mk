###########################################################################
## Makefile generated for component 'CONTROL_SYSTEM_V3_k'. 
## 
## Makefile     : CONTROL_SYSTEM_V3_k.mk
## Generated on : Tue Oct 15 11:47:12 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/CONTROL_SYSTEM_V3_k.elf
...
PRODUCT_NAME              = CONTROL_SYSTEM_V3_k
MAKEFILE                  = CONTROL_SYSTEM_V3_k.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/CONTROL_SYSTEM_V3_k.elf
...
DEFINES_STANDARD = -DMODEL=CONTROL_SYSTEM_V3_k -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = Adafruit_ADS1X15.o Adafruit_I2CDevice.o ADS1115_Vread.o MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o CONTROL_SYSTEM_V3_k.o CONTROL_SYSTEM_V3_k_data.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/CONTROL_SYSTEM_V3_k_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/CONTROL_SYSTEM_V3_k_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/CONTROL_SYSTEM_V3_k_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/CONTROL_SYSTEM_V3_k_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


CONTROL_SYSTEM_V3_k.o : $(START_DIR)/CONTROL_SYSTEM_V3_k_ert_rtw/CONTROL_SYSTEM_V3_k.c
	$(CC) $(CFLAGS) -o "$@" "$<"


CONTROL_SYSTEM_V3_k_data.o : $(START_DIR)/CONTROL_SYSTEM_V3_k_ert_rtw/CONTROL_SYSTEM_V3_k_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
