...
typedef struct {
  ...
  real_T Add3_d;                       /* '<S5>/Add3' */
  real_T Divide1_f;                    /* '<S5>/Divide1' */
  real_T Sum_a;                        /* '<S5>/Sum' */
  real_T PulseGenerator;               /* '<S3>/Pulse Generator' */
  real_T PercentageError;              /* '<S12>/Gain' */
  real_T PulseGenerator_m;             /* '<S4>/Pulse Generator' */
  real_T EnablePin;                    /* '<S7>/Enable Pin' */
  real_T DirectionPin;                 /* '<S7>/Direction Pin' */
...
typedef struct {
  ...
  int8_T ADRCControl_SubsysRanBC;      /* '<Root>/ADRC Control' */
  int8_T PIDControl_SubsysRanBC;       /* '<Root>/PID Control' */
  int8_T Propotional_SubsysRanBC;      /* '<Root>/Propotional' */
  int8_T ONDelay_SubsysRanBC;          /* '<S30>/ON Delay' */
  int8_T TriggeredSubsystem_SubsysRanBC;/* '<S44>/Triggered Subsystem' */
  int8_T OFFDelay_SubsysRanBC;         /* '<S30>/OFF Delay' */
  int8_T TriggeredSubsystem_SubsysRanB_a;/* '<S36>/Triggered Subsystem' */
