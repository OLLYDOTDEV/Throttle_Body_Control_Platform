 ...
 * C/C++ source code generated on : Thu Nov 14 12:37:03 2024
 *
...
void CONTROL_SYSTEM_V3_step(void)
{
  ...
  srClearBC(CONTROL_SYSTEM_V3_DW.TriggeredSubsystem_SubsysRanB_a);
  ...
  /* Reset subsysRan breadcrumbs */
  srClearBC(CONTROL_SYSTEM_V3_DW.Propotional_SubsysRanBC);

  /* Reset subsysRan breadcrumbs */
  srClearBC(CONTROL_SYSTEM_V3_DW.PIDControl_SubsysRanBC);

  /* Reset subsysRan breadcrumbs */
  srClearBC(CONTROL_SYSTEM_V3_DW.ADRCControl_SubsysRanBC);
  ...
  if (rtmIsMajorTimeStep(CONTROL_SYSTEM_V3_M)) {
    ...
    if (CONTROL_SYSTEM_V3_B.MATLABSystem_o3 > CONTROL_SYSTEM_V3_DW.maxSet) {
      CONTROL_SYSTEM_V3_DW.maxSet = CONTROL_SYSTEM_V3_B.MATLABSystem_o3;
    }

    if (CONTROL_SYSTEM_V3_B.MATLABSystem_o3 < CONTROL_SYSTEM_V3_DW.minSet) {
      CONTROL_SYSTEM_V3_DW.minSet = CONTROL_SYSTEM_V3_B.MATLABSystem_o3;
    }
  ...
  /* Sum: '<Root>/Sum2' */
  CONTROL_SYSTEM_V3_B.Error = CONTROL_SYSTEM_V3_B.MATLABSystem_o3 -
  ...
  switch (rtAction) {
   case 0:
    ...
    if (rtsiIsModeUpdateTimeStep(&CONTROL_SYSTEM_V3_M->solverInfo)) {
      srUpdateBC(CONTROL_SYSTEM_V3_DW.Propotional_SubsysRanBC);
    }
   ...
   case 1:
    ...
    CONTROL_SYSTEM_V3_B.FilterCoefficient = (CONTROL_SYSTEM_V3_P.Kd *
      CONTROL_SYSTEM_V3_B.Error - CONTROL_SYSTEM_V3_X.Filter_CSTATE) *
     ...
     */
    CONTROL_SYSTEM_V3_B.Sum_k = (CONTROL_SYSTEM_V3_P.Kp *
      CONTROL_SYSTEM_V3_B.Error + CONTROL_SYSTEM_V3_X.Integrator_CSTATE_b) +
     ...
     *  Switch: '<S54>/Switch'
     */
    if (CONTROL_SYSTEM_V3_B.Sum_k > CONTROL_SYSTEM_V3_B.Sum1) {
      /* Switch: '<S54>/Switch2' */
      CONTROL_SYSTEM_V3_B.Switch2_j = CONTROL_SYSTEM_V3_B.Sum1;
    } else if (CONTROL_SYSTEM_V3_B.Sum_k < CONTROL_SYSTEM_V3_B.FP_minVal) {
       ...
       *  Switch: '<S54>/Switch'
       */
      CONTROL_SYSTEM_V3_B.Switch2_j = CONTROL_SYSTEM_V3_B.Sum_k;
    }
    ...
    if (rtsiIsModeUpdateTimeStep(&CONTROL_SYSTEM_V3_M->solverInfo)) {
      srUpdateBC(CONTROL_SYSTEM_V3_DW.PIDControl_SubsysRanBC);
    }
   ...
   case 2:
     ...
     *  Sum: '<S23>/Sum2'
     */
    CONTROL_SYSTEM_V3_B.Switch2 = (((CONTROL_SYSTEM_V3_B.MATLABSystem_o3 -
    ...
    for (rowIdx = 0; rowIdx < 3; rowIdx++) {
      ...
      CONTROL_SYSTEM_V3_B.dxe[rowIdx] =
        ((CONTROL_SYSTEM_V3_P.Constant_Value_i[rowIdx + 3] * Integrator_CSTATE +
          CONTROL_SYSTEM_V3_P.Constant_Value_i[rowIdx] * Integrator_CSTATE_0) +
         CONTROL_SYSTEM_V3_P.Constant_Value_i[rowIdx + 6] * Integrator_CSTATE_1)
     ...
     *  Product: '<S1>/Divide'
     */
    rtb_Sum1 = CONTROL_SYSTEM_V3_B.MATLABSystem_o3 /
      CONTROL_SYSTEM_V3_P.Constant_Value_ih +
      CONTROL_SYSTEM_V3_B.MATLABSystem_o3;
    ...
    if (rtsiIsModeUpdateTimeStep(&CONTROL_SYSTEM_V3_M->solverInfo)) {
      srUpdateBC(CONTROL_SYSTEM_V3_DW.ADRCControl_SubsysRanBC);
    }
  ...
  if (CONTROL_SYSTEM_V3_DW.ONDelay_MODE) {
     ...
     *  Sum: '<S32>/Sum'
     */
    CONTROL_SYSTEM_V3_B.LogicalOperator2_f = ((rtb_Sum1 >=
  ...
  if (CONTROL_SYSTEM_V3_DW.OFFDelay_MODE) {
    ...
    if (LogicalOperator1) {
      /* Switch: '<S40>/Switch' */
      CONTROL_SYSTEM_V3_B.Switch_d = rtb_Sum1;
    } else {
      /* Switch: '<S40>/Switch' */
     ...
     *  Sum: '<S31>/Sum'
     */
    CONTROL_SYSTEM_V3_B.LogicalOperator2_l = ((!(rtb_Sum1 >=
      ...
      if (rtsiIsModeUpdateTimeStep(&CONTROL_SYSTEM_V3_M->solverInfo)) {
        if (LogicalOperator1 &&
            (CONTROL_SYSTEM_V3_PrevZCX.TriggeredSubsystem_Trig_ZCE_f !=
             POS_ZCSIG)) {
          CONTROL_SYSTEM_V3_DW.TriggeredSubsystem_SubsysRanB_a = 4;
        }
  ...
  if (rtmIsMajorTimeStep(CONTROL_SYSTEM_V3_M)) {
     ...
     */
    CONTROL_SYSTEM_V3_B.Add2_g = CONTROL_SYSTEM_V3_P.Desire_Max -
      CONTROL_SYSTEM_V3_P.Desire_Min;

    /* Sum: '<S5>/Add3' */
    CONTROL_SYSTEM_V3_B.Add3_d = CONTROL_SYSTEM_V3_B.FP_maxVal -
      CONTROL_SYSTEM_V3_B.FP_minVal;

    /* Product: '<S5>/Divide1' */
    CONTROL_SYSTEM_V3_B.Divide1_f = CONTROL_SYSTEM_V3_B.Add2_g /
      CONTROL_SYSTEM_V3_B.Add3_d;
  }
  ...
  switch ((uint8_T)(((((uint32_T)(CONTROL_SYSTEM_V3_B.Logic_e[0] ? (int32_T)
   ...
   case 2:
    rtb_Sum1 = CONTROL_SYSTEM_V3_B.Switch2_j;
    break;
   ...
   *  Sum: '<S5>/Subtract'
   */
  CONTROL_SYSTEM_V3_B.Sum_a = (rtb_Sum1 - CONTROL_SYSTEM_V3_B.FP_minVal) *
  ...
  if (CONTROL_SYSTEM_V3_B.LogicalOperator2_f ||
     ...
     *  Gain: '<S7>/Gain'
     */
    rtb_Sum1 = (real_T)(CONTROL_SYSTEM_V3_B.Logic_l[0] ? (int32_T)
                        CONTROL_SYSTEM_V3_P.Gain_Gain_k : 0) * 0.5;
  } else {
    /* Switch: '<S7>/Switch1' */
    rtb_Sum1 = CONTROL_SYSTEM_V3_B.Sum_a;
  }
  ...
  if (CONTROL_SYSTEM_V3_B.Logic_l[0]) {
    ...
    rtb_Sum1 = CONTROL_SYSTEM_V3_P.Constant_Value_d;
  }
   ...
   *  Product: '<S12>/Divide'
   */
  CONTROL_SYSTEM_V3_B.PercentageError = fabs(CONTROL_SYSTEM_V3_B.Error /
    CONTROL_SYSTEM_V3_B.Sum) * CONTROL_SYSTEM_V3_P.Gain_Gain_j;
  if (rtmIsMajorTimeStep(CONTROL_SYSTEM_V3_M)) {
  ...
  {
    rtb_Sum1 = CONTROL_SYSTEM_V3_P.Constant_Value_a;
  } else {
    rtb_Sum1 = CONTROL_SYSTEM_V3_P.Constant1_Value_o;
  }
  ...
  if (CONTROL_SYSTEM_V3_B.MATLABSystem_o3 >
    ...
    Integrator_CSTATE = CONTROL_SYSTEM_V3_P.Constant2_Value_j;
  } else {
    Integrator_CSTATE = CONTROL_SYSTEM_V3_P.Constant3_Value_f;
  }
  ...
  if ((!(rtb_Sum1 != 0.0)) || (!(Integrator_CSTATE != 0.0))) {
    rtb_Sum1 = CONTROL_SYSTEM_V3_B.PulseGenerator_m;
  } else {
  ...
  if (rtmIsMajorTimeStep(CONTROL_SYSTEM_V3_M)) {
    ...
    /* MATLABSystem: '<S7>/Digital Output1' */
...
void CONTROL_SYSTEM_V3_initialize(void)
{
  ...
  /* External mode info */
  CONTROL_SYSTEM_V3_M->Sizes.checksums[0] = (2583161117U);
  CONTROL_SYSTEM_V3_M->Sizes.checksums[1] = (841859856U);
  CONTROL_SYSTEM_V3_M->Sizes.checksums[2] = (182346179U);
  CONTROL_SYSTEM_V3_M->Sizes.checksums[3] = (3154082568U);

  {
    ...
    systemRan[1] = (sysRanDType *)&CONTROL_SYSTEM_V3_DW.ADRCControl_SubsysRanBC;
    systemRan[2] = (sysRanDType *)&CONTROL_SYSTEM_V3_DW.ADRCControl_SubsysRanBC;
    ...
    systemRan[12] = (sysRanDType *)
      &CONTROL_SYSTEM_V3_DW.TriggeredSubsystem_SubsysRanB_a;
    ...
    systemRan[20] = (sysRanDType *)
      &CONTROL_SYSTEM_V3_DW.NEGATIVEEdge_d.NEGATIVEEdge_SubsysRanBC;
    systemRan[21] = (sysRanDType *)
      &CONTROL_SYSTEM_V3_DW.POSITIVEEdge_j.POSITIVEEdge_SubsysRanBC;
    ...
    systemRan[33] = (sysRanDType *)&CONTROL_SYSTEM_V3_DW.PIDControl_SubsysRanBC;
    systemRan[34] = (sysRanDType *)&CONTROL_SYSTEM_V3_DW.PIDControl_SubsysRanBC;
    systemRan[35] = (sysRanDType *)&CONTROL_SYSTEM_V3_DW.Propotional_SubsysRanBC;
  ...
  /* SystemInitialize for Switch: '<S54>/Switch2' incorporates:
