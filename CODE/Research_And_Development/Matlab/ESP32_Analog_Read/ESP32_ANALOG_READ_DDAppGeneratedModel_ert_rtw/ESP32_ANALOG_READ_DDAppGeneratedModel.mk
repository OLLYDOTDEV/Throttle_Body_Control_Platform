###########################################################################
## Makefile generated for component 'ESP32_ANALOG_READ_DDAppGeneratedModel'. 
## 
## Makefile     : ESP32_ANALOG_READ_DDAppGeneratedModel.mk
## Generated on : Tue Aug 06 15:02:28 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ESP32_ANALOG_READ_DDAppGeneratedModel.elf
...
PRODUCT_NAME              = ESP32_ANALOG_READ_DDAppGeneratedModel
MAKEFILE                  = ESP32_ANALOG_READ_DDAppGeneratedModel.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = E:/Banana444/Documents/GitHub/Throttle_Body_Control_Platform/CODE/Research_And_Development/Matlab/ESP32_Analog_Read
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ESP32_ANALOG_READ_DDAppGeneratedModel.elf
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DEXTMODE_XCP_TRIGGER_SUPPORT -DXCP_MEM_BLOCK_1_SIZE=32 -DXCP_MEM_BLOCK_1_NUMBER=1 -DXCP_MEM_BLOCK_2_SIZE=56 -DXCP_MEM_BLOCK_2_NUMBER=1 -DXCP_MEM_BLOCK_3_SIZE=120 -DXCP_MEM_BLOCK_3_NUMBER=1 -DXCP_MEM_RESERVED_POOLS_TOTAL_SIZE=949 -DXCP_MEM_RESERVED_POOLS_NUMBER=2 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3 -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=1 -DXCP_MIN_EVENT_NO_RESERVED_POOL=1 -DXCP_MAX_CTO_SIZE=32 -DXCP_MAX_DTO_SIZE=65532 -DXCP_MAX_ODT_ENTRY_SIZE=255 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=65536 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0
...
DEFINES_STANDARD = -DMODEL=ESP32_ANALOG_READ_DDAppGeneratedModel -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/ESP32_ANALOG_READ_DDAppGeneratedModel_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/ESP32_ANALOG_READ_DDAppGeneratedModel_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ESP32_ANALOG_READ_DDAppGeneratedModel_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/ESP32_ANALOG_READ_DDAppGeneratedModel_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ESP32_ANALOG_READ_DDAppGeneratedModel.o : $(START_DIR)/ESP32_ANALOG_READ_DDAppGeneratedModel_ert_rtw/ESP32_ANALOG_READ_DDAppGeneratedModel.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ESP32_ANALOG_READ_DDAppGeneratedModel_data.o : $(START_DIR)/ESP32_ANALOG_READ_DDAppGeneratedModel_ert_rtw/ESP32_ANALOG_READ_DDAppGeneratedModel_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
