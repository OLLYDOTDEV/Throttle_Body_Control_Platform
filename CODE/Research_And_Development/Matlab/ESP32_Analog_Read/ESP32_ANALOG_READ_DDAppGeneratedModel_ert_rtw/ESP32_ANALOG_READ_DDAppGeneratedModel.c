...
void ESP32_ANALOG_READ_DDAppGeneratedModel_step(void)
{
  ...
  stepFunctionESP32_ANALOG_READ(36,
  ...
  stepFunctionESP32_ANALOG_READ(39,
...
void ESP32_ANALOG_READ_DDAppGeneratedModel_initialize(void)
{
  ...
  /* External mode info */
  ESP32_ANALOG_READ_DDAppGener_M->Sizes.checksums[0] = (4009684066U);
  ESP32_ANALOG_READ_DDAppGener_M->Sizes.checksums[1] = (52599983U);
  ESP32_ANALOG_READ_DDAppGener_M->Sizes.checksums[2] = (4247438916U);
  ESP32_ANALOG_READ_DDAppGener_M->Sizes.checksums[3] = (1060550286U);
  ...
  /*         %% Define output properties */
  /*   Check the input size */
  setupFunctionESP32_ANALOG_READ(39, 1.0);
