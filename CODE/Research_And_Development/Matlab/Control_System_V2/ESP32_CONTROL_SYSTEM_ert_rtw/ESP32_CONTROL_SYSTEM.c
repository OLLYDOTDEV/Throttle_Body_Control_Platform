...
void ESP32_CONTROL_SYSTEM_initialize(void)
{
  ...
  /* External mode info */
  ESP32_CONTROL_SYSTEM_M->Sizes.checksums[0] = (2008138995U);
  ESP32_CONTROL_SYSTEM_M->Sizes.checksums[1] = (3721795168U);
  ESP32_CONTROL_SYSTEM_M->Sizes.checksums[2] = (4098991818U);
  ESP32_CONTROL_SYSTEM_M->Sizes.checksums[3] = (1391195534U);
