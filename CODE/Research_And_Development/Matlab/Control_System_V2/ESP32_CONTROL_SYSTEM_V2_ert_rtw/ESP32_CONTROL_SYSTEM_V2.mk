###########################################################################
## Makefile generated for component 'ESP32_CONTROL_SYSTEM_V2'. 
## 
## Makefile     : ESP32_CONTROL_SYSTEM_V2.mk
## Generated on : Wed Aug 21 16:28:20 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ESP32_CONTROL_SYSTEM_V2.elf
...
PRODUCT_NAME              = ESP32_CONTROL_SYSTEM_V2
MAKEFILE                  = ESP32_CONTROL_SYSTEM_V2.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ESP32_CONTROL_SYSTEM_V2.elf
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DEXTMODE_XCP_TRIGGER_SUPPORT -DXCP_MEM_BLOCK_1_SIZE=32 -DXCP_MEM_BLOCK_1_NUMBER=1 -DXCP_MEM_BLOCK_2_SIZE=56 -DXCP_MEM_BLOCK_2_NUMBER=1 -DXCP_MEM_BLOCK_3_SIZE=176 -DXCP_MEM_BLOCK_3_NUMBER=1 -DXCP_MEM_RESERVED_POOLS_TOTAL_SIZE=1117 -DXCP_MEM_RESERVED_POOLS_NUMBER=2 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3 -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=1 -DXCP_MIN_EVENT_NO_RESERVED_POOL=1 -DXCP_MAX_CTO_SIZE=32 -DXCP_MAX_DTO_SIZE=65532 -DXCP_MAX_ODT_ENTRY_SIZE=255 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=65536 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0
...
DEFINES_STANDARD = -DMODEL=ESP32_CONTROL_SYSTEM_V2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o Adafruit_ADS1X15.o Adafruit_I2CDevice.o ADS1115_Vread.o xcp_ext_mode.o ESP32_CONTROL_SYSTEM_V2.o ESP32_CONTROL_SYSTEM_V2_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/ESP32_CONTROL_SYSTEM_V2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/ESP32_CONTROL_SYSTEM_V2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ESP32_CONTROL_SYSTEM_V2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/ESP32_CONTROL_SYSTEM_V2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ESP32_CONTROL_SYSTEM_V2.o : $(START_DIR)/ESP32_CONTROL_SYSTEM_V2_ert_rtw/ESP32_CONTROL_SYSTEM_V2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ESP32_CONTROL_SYSTEM_V2_data.o : $(START_DIR)/ESP32_CONTROL_SYSTEM_V2_ert_rtw/ESP32_CONTROL_SYSTEM_V2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
