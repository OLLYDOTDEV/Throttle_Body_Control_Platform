 ...
 * use.
 *
 * File: CONTROL_SYSTEM_V3_k_private.h
 *
...
#ifndef CONTROL_SYSTEM_V3_k_private_h_
#define CONTROL_SYSTEM_V3_k_private_h_
#include "rtwtypes.h"
...
extern void CONTROL_SY_NEGATIVEEdge_Disable(DW_NEGATIVEEdge_CONTROL_SYSTE_T
  *localDW);
extern void CONTROL_SYSTEM_V3__NEGATIVEEdge(RT_MODEL_CONTROL_SYSTEM_V3_k_T *
  const CONTROL_SYSTEM_V3_k_M, real_T rtu_Enable, boolean_T rtu_IN, boolean_T
...
extern void CONTROL_SY_POSITIVEEdge_Disable(DW_POSITIVEEdge_CONTROL_SYSTE_T
  *localDW);
extern void CONTROL_SYSTEM_V3__POSITIVEEdge(RT_MODEL_CONTROL_SYSTEM_V3_k_T *
  const CONTROL_SYSTEM_V3_k_M, real_T rtu_Enable, boolean_T rtu_IN, boolean_T
  rtu_INprevious, boolean_T *rty_OUT, DW_POSITIVEEdge_CONTROL_SYSTE_T *localDW);

/* private model entry point functions */
extern void CONTROL_SYSTEM_V3_k_derivatives(void);

#endif                                 /* CONTROL_SYSTEM_V3_k_private_h_ */
