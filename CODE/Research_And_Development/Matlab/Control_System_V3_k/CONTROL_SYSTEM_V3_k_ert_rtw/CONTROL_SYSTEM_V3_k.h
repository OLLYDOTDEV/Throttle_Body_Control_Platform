...
#ifndef CONTROL_SYSTEM_V3_k_h_
#define CONTROL_SYSTEM_V3_k_h_
#ifndef CONTROL_SYSTEM_V3_k_COMMON_INCLUDES_
#define CONTROL_SYSTEM_V3_k_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "MW_PWM.h"
#endif                                /* CONTROL_SYSTEM_V3_k_COMMON_INCLUDES_ */
...
} B_CONTROL_SYSTEM_V3_k_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  ADS1115_Vread_CONTROL_SYSTEM__T obj; /* '<S1>/MATLAB System' */
  codertarget_arduinobase_blo_f_T obj_m;/* '<S7>/Digital Input3' */
  codertarget_arduinobase_blo_f_T obj_d;/* '<S7>/Digital Input2' */
  codertarget_arduinobase_blo_f_T obj_e;/* '<S7>/Digital Input1' */
  codertarget_arduinobase_blo_f_T obj_dc;/* '<S7>/Digital Input' */
...
struct P_CONTROL_SYSTEM_V3_k_T_ {
...
struct tag_RTM_CONTROL_SYSTEM_V3_k_T {
  const char_T *errorStatus;
  RTWSolverInfo solverInfo;
  X_CONTROL_SYSTEM_V3_k_T *contStates;
  int_T *periodicContStateIndices;
  real_T *periodicContStateRanges;
  real_T *derivs;
  XDis_CONTROL_SYSTEM_V3_k_T *contStateDisabled;
...
extern P_CONTROL_SYSTEM_V3_k_T CONTROL_SYSTEM_V3_k_P;

/* Block signals (default storage) */
extern B_CONTROL_SYSTEM_V3_k_T CONTROL_SYSTEM_V3_k_B;

/* Continuous states (default storage) */
extern X_CONTROL_SYSTEM_V3_k_T CONTROL_SYSTEM_V3_k_X;

/* Disabled states (default storage) */
extern XDis_CONTROL_SYSTEM_V3_k_T CONTROL_SYSTEM_V3_k_XDis;

/* Block states (default storage) */
extern DW_CONTROL_SYSTEM_V3_k_T CONTROL_SYSTEM_V3_k_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_CONTROL_SYSTEM_V3_k_T CONTROL_SYSTEM_V3_k_PrevZCX;

/* Model entry point functions */
extern void CONTROL_SYSTEM_V3_k_initialize(void);
extern void CONTROL_SYSTEM_V3_k_step(void);
extern void CONTROL_SYSTEM_V3_k_terminate(void);

/* Real-time Model object */
extern RT_MODEL_CONTROL_SYSTEM_V3_k_T *const CONTROL_SYSTEM_V3_k_M;
 ...
 *
 * '<Root>' : 'CONTROL_SYSTEM_V3_k'
 * '<S1>'   : 'CONTROL_SYSTEM_V3_k/Analog Signal'
 * '<S2>'   : 'CONTROL_SYSTEM_V3_k/Button Control LED'
 * '<S3>'   : 'CONTROL_SYSTEM_V3_k/Error Indication'
 * '<S4>'   : 'CONTROL_SYSTEM_V3_k/FP_Input Range Conversion'
 * '<S5>'   : 'CONTROL_SYSTEM_V3_k/Foot Pedal Calibration'
 * '<S6>'   : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting'
 * '<S7>'   : 'CONTROL_SYSTEM_V3_k/Latching'
 * '<S8>'   : 'CONTROL_SYSTEM_V3_k/Operation Selector'
 * '<S9>'   : 'CONTROL_SYSTEM_V3_k/PID Control'
 * '<S10>'  : 'CONTROL_SYSTEM_V3_k/Propotional'
 * '<S11>'  : 'CONTROL_SYSTEM_V3_k/Subsystem'
 * '<S12>'  : 'CONTROL_SYSTEM_V3_k/TB_Feedbakc Range Conversion'
 * '<S13>'  : 'CONTROL_SYSTEM_V3_k/Throttle Body Callibration'
 * '<S14>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay'
 * '<S15>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model'
 * '<S16>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/OFF Delay'
 * '<S17>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/ON Delay'
 * '<S18>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/OFF Delay/Edge Detector'
 * '<S19>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/OFF Delay/Sample and Hold'
 * '<S20>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/OFF Delay/Edge Detector/Model'
 * '<S21>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/OFF Delay/Edge Detector/Model/Internal dirac generator'
 * '<S22>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/OFF Delay/Edge Detector/Model/NEGATIVE Edge'
 * '<S23>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/OFF Delay/Edge Detector/Model/POSITIVE Edge'
 * '<S24>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/OFF Delay/Edge Detector/Model/Internal dirac generator/Triggered Subsystem'
 * '<S25>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/OFF Delay/Sample and Hold/Model'
 * '<S26>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/ON Delay/Edge Detector'
 * '<S27>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/ON Delay/Sample and Hold'
 * '<S28>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/ON Delay/Edge Detector/Model'
 * '<S29>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/ON Delay/Edge Detector/Model/Internal dirac generator'
 * '<S30>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/ON Delay/Edge Detector/Model/NEGATIVE Edge'
 * '<S31>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/ON Delay/Edge Detector/Model/POSITIVE Edge'
 * '<S32>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/ON Delay/Edge Detector/Model/Internal dirac generator/Triggered Subsystem'
 * '<S33>'  : 'CONTROL_SYSTEM_V3_k/H-Bridge Setting/On Delay/Model/ON Delay/Sample and Hold/Model'
 * '<S34>'  : 'CONTROL_SYSTEM_V3_k/Latching/S-R Flip-Flop3'
 * '<S35>'  : 'CONTROL_SYSTEM_V3_k/Latching/S-R Flip-Flop4'
 * '<S36>'  : 'CONTROL_SYSTEM_V3_k/Latching/S-R Flip-Flop5'
 * '<S37>'  : 'CONTROL_SYSTEM_V3_k/Latching/S-R Flip-Flop6'
 * '<S38>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1'
 * '<S39>'  : 'CONTROL_SYSTEM_V3_k/PID Control/Saturation Dynamic'
 * '<S40>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Anti-windup'
 * '<S41>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/D Gain'
 * '<S42>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/External Derivative'
 * '<S43>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Filter'
 * '<S44>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Filter ICs'
 * '<S45>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/I Gain'
 * '<S46>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Ideal P Gain'
 * '<S47>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Ideal P Gain Fdbk'
 * '<S48>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Integrator'
 * '<S49>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Integrator ICs'
 * '<S50>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/N Copy'
 * '<S51>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/N Gain'
 * '<S52>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/P Copy'
 * '<S53>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Parallel P Gain'
 * '<S54>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Reset Signal'
 * '<S55>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Saturation'
 * '<S56>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Saturation Fdbk'
 * '<S57>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Sum'
 * '<S58>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Sum Fdbk'
 * '<S59>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Tracking Mode'
 * '<S60>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Tracking Mode Sum'
 * '<S61>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Tsamp - Integral'
 * '<S62>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Tsamp - Ngain'
 * '<S63>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/postSat Signal'
 * '<S64>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/preSat Signal'
 * '<S65>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Anti-windup/Passthrough'
 * '<S66>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/D Gain/Internal Parameters'
 * '<S67>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/External Derivative/Error'
 * '<S68>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Filter/Cont. Filter'
 * '<S69>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Filter ICs/Internal IC - Filter'
 * '<S70>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/I Gain/Internal Parameters'
 * '<S71>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Ideal P Gain/Passthrough'
 * '<S72>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Ideal P Gain Fdbk/Disabled'
 * '<S73>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Integrator/Continuous'
 * '<S74>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Integrator ICs/Internal IC'
 * '<S75>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/N Copy/Disabled'
 * '<S76>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/N Gain/Internal Parameters'
 * '<S77>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/P Copy/Disabled'
 * '<S78>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Parallel P Gain/Internal Parameters'
 * '<S79>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Reset Signal/Disabled'
 * '<S80>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Saturation/Passthrough'
 * '<S81>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Saturation Fdbk/Disabled'
 * '<S82>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Sum/Sum_PID'
 * '<S83>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Sum Fdbk/Disabled'
 * '<S84>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Tracking Mode/Disabled'
 * '<S85>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Tracking Mode Sum/Passthrough'
 * '<S86>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Tsamp - Integral/TsSignalSpecification'
 * '<S87>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/Tsamp - Ngain/Passthrough'
 * '<S88>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/postSat Signal/Forward_Path'
 * '<S89>'  : 'CONTROL_SYSTEM_V3_k/PID Control/PID Controller1/preSat Signal/Forward_Path'
 */
#endif                                 /* CONTROL_SYSTEM_V3_k_h_ */
