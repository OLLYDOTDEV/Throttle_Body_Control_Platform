...
## Generated on : Thu Aug 15 16:48:14 2024
## Final product: ./ESP32_CONTROL_SYSTEM.exe
...
COMPILER_COMMAND_FILE     = ESP32_CONTROL_SYSTEM_comp.rsp
CMD_FILE                  = ESP32_CONTROL_SYSTEM.rsp
...
PRODUCT = ./ESP32_CONTROL_SYSTEM.exe
...
DEFINES_STANDARD = -DMODEL=ESP32_CONTROL_SYSTEM -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = ESP32_ANALOG_READ.obj LEDC_INTERFACE.obj MW_PWM.obj MW_PWMDriver.obj ArduinoPinHandleMap.obj ESP32_CONTROL_SYSTEM.obj ESP32_CONTROL_SYSTEM_capi.obj ESP32_CONTROL_SYSTEM_data.obj ESP32_CONTROL_SYSTEM_tgtconn.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.obj : $(START_DIR)/slprj/raccel/ESP32_CONTROL_SYSTEM/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/ESP32_CONTROL_SYSTEM/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/ESP32_CONTROL_SYSTEM/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/ESP32_CONTROL_SYSTEM/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/ESP32_CONTROL_SYSTEM/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ESP32_ANALOG_READ.obj : $(START_DIR)/ESP32_ANALOG_READ.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


LEDC_INTERFACE.obj : $(START_DIR)/LEDC_INTERFACE.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MW_PWM.obj : C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/MW_PWM.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MW_PWMDriver.obj : C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/MW_PWMDriver.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ArduinoPinHandleMap.obj : C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/ArduinoPinHandleMap.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ESP32_CONTROL_SYSTEM.obj : $(START_DIR)/slprj/raccel/ESP32_CONTROL_SYSTEM/ESP32_CONTROL_SYSTEM.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ESP32_CONTROL_SYSTEM_capi.obj : $(START_DIR)/slprj/raccel/ESP32_CONTROL_SYSTEM/ESP32_CONTROL_SYSTEM_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ESP32_CONTROL_SYSTEM_data.obj : $(START_DIR)/slprj/raccel/ESP32_CONTROL_SYSTEM/ESP32_CONTROL_SYSTEM_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ESP32_CONTROL_SYSTEM_tgtconn.obj : $(START_DIR)/slprj/raccel/ESP32_CONTROL_SYSTEM/ESP32_CONTROL_SYSTEM_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/ESP32_CONTROL_SYSTEM/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
