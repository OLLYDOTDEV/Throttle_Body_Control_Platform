###########################################################################
## Makefile generated for component 'ADS1115_Vread_DDAppGeneratedModel'. 
## 
## Makefile     : ADS1115_Vread_DDAppGeneratedModel.mk
## Generated on : Sat Aug 03 13:17:29 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ADS1115_Vread_DDAppGeneratedModel.elf
...
PRODUCT_NAME              = ADS1115_Vread_DDAppGeneratedModel
MAKEFILE                  = ADS1115_Vread_DDAppGeneratedModel.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ADS1115_Vread_DDAppGeneratedModel.elf
...
DEFINES_STANDARD = -DMODEL=ADS1115_Vread_DDAppGeneratedModel -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = Adafruit_ADS1X15.o Adafruit_I2CDevice.o ADS1115_Vread.o ADS1115_Vread_DDAppGeneratedModel.o ADS1115_Vread_DDAppGeneratedModel_data.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o
...
%.o : $(START_DIR)/ADS1115_Vread_DDAppGeneratedModel_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/ADS1115_Vread_DDAppGeneratedModel_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ADS1115_Vread_DDAppGeneratedModel_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/ADS1115_Vread_DDAppGeneratedModel_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ADS1115_Vread_DDAppGeneratedModel.o : $(START_DIR)/ADS1115_Vread_DDAppGeneratedModel_ert_rtw/ADS1115_Vread_DDAppGeneratedModel.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ADS1115_Vread_DDAppGeneratedModel_data.o : $(START_DIR)/ADS1115_Vread_DDAppGeneratedModel_ert_rtw/ADS1115_Vread_DDAppGeneratedModel_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
