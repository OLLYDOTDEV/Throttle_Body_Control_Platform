###########################################################################
## Makefile generated for component 'ESP32_PWM'. 
## 
## Makefile     : ESP32_PWM.mk
## Generated on : Sat Aug 03 16:10:15 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ESP32_PWM.elf
...
PRODUCT_NAME              = ESP32_PWM
MAKEFILE                  = ESP32_PWM.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/obell/Documents/GitHub/Throttle_Body_Control_Platform/CODE/Research_And_Development/Matlab/ESP32_PWM
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ESP32_PWM.elf
...
DEFINES_STANDARD = -DMODEL=ESP32_PWM -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = LEDC_INTERFACE.o xcp_ext_mode.o ESP32_PWM.o ESP32_PWM_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/ESP32_PWM_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/ESP32_PWM_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ESP32_PWM_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/ESP32_PWM_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ESP32_PWM.o : $(START_DIR)/ESP32_PWM_ert_rtw/ESP32_PWM.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ESP32_PWM_data.o : $(START_DIR)/ESP32_PWM_ert_rtw/ESP32_PWM_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
