...
void ADS1115_Single_Ended_Read_V2_step(void)
{
  ...
  ADS1115_Single_Ended_Read_V2_B.MATLABSystem_o1 = 0;

  /* MATLABSystem: '<Root>/MATLAB System' */
  ADS1115_Single_Ended_Read_V2_B.MATLABSystem_o2 = 0;

  /* MATLABSystem: '<Root>/MATLAB System' */
  ADS1115_Single_Ended_Read_V2_B.MATLABSystem_o3 = 0;

  /* MATLABSystem: '<Root>/MATLAB System' */
  ADS1115_Single_Ended_Read_V2_B.MATLABSystem_o4 = 0;
...
void ADS1115_Single_Ended_Read_V2_initialize(void)
{
  ...
  /* External mode info */
  ADS1115_Single_Ended_Read_V2_M->Sizes.checksums[0] = (2598051280U);
  ADS1115_Single_Ended_Read_V2_M->Sizes.checksums[1] = (3716670805U);
  ADS1115_Single_Ended_Read_V2_M->Sizes.checksums[2] = (4207833641U);
  ADS1115_Single_Ended_Read_V2_M->Sizes.checksums[3] = (1016231785U);
