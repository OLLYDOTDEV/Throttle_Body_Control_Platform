...
typedef struct {
  int16_T MATLABSystem_o1;             /* '<Root>/MATLAB System' */
  int16_T MATLABSystem_o2;             /* '<Root>/MATLAB System' */
  int16_T MATLABSystem_o3;             /* '<Root>/MATLAB System' */
  int16_T MATLABSystem_o4;             /* '<Root>/MATLAB System' */
