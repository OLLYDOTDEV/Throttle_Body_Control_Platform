 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Jul 22 21:28:57 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                ADS1115_Interface
...
extern void ADS1115_Interface_Outputs_wrapper(int16_T *A0,
  int16_T *A2,
  int16_T *A1,
  int16_T *A3,
  const real_T *xD);
extern void ADS1115_Interface_Update_wrapper(int16_T *A0,
  int16_T *A2,
  int16_T *A1,
  int16_T *A3,
  real_T *xD);
extern void ADS1115_Interface_Terminate_wrapper(real_T *xD);
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port A0 of S-Function ADS1115_Interface");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port A2 of S-Function ADS1115_Interface");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port A1 of S-Function ADS1115_Interface");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port A3 of S-Function ADS1115_Interface");
      return;
    }
...
{
  int16_T *A0 = (int16_T *) ssGetOutputPortRealSignal(S, 0);
  int16_T *A2 = (int16_T *) ssGetOutputPortRealSignal(S, 1);
  int16_T *A1 = (int16_T *) ssGetOutputPortRealSignal(S, 2);
  int16_T *A3 = (int16_T *) ssGetOutputPortRealSignal(S, 3);
  const real_T *xD = ssGetDiscStates(S);
  ADS1115_Interface_Outputs_wrapper(A0, A2, A1, A3, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  ADS1115_Interface_Update_wrapper(A0, A2, A1, A3, xD);
}
...
{
  real_T *xD = ssGetDiscStates(S);
  ADS1115_Interface_Terminate_wrapper(xD);
}
