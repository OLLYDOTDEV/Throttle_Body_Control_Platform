###########################################################################
## Makefile generated for component 'RPI_ADS1115'. 
## 
## Makefile     : RPI_ADS1115.mk
## Generated on : Tue Jul 23 13:58:21 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/RPI_ADS1115.elf
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/obell/Documents/GitHub/Throttle_Body_Control_Platform/CODE/Research_and_development/Matlab/RPI_ADS
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/RPI_ADS1115.elf
...
DEFINES_STANDARD = -DMODEL=RPI_ADS1115 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = RPI_ADS1115.c.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.c.o
...
%.c.o : $(START_DIR)/RPI_ADS1115_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/RPI_ADS1115_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/RPI_ADS1115_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/RPI_ADS1115_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


RPI_ADS1115.c.o : $(START_DIR)/RPI_ADS1115_ert_rtw/RPI_ADS1115.c
	$(CC) $(CFLAGS) -o "$@" "$<"
