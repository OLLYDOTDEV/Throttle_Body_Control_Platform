###########################################################################
## Makefile generated for component 'INPUT_TESTING'. 
## 
## Makefile     : INPUT_TESTING.mk
## Generated on : Thu Jul 18 14:31:24 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/INPUT_TESTING.elf
...
PRODUCT_NAME              = INPUT_TESTING
MAKEFILE                  = INPUT_TESTING.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = E:/BANANA~1/DOCUME~1/GitHub/THROTT~1/CODE/R&D/Matlab/CONNOR~1/CONNOR~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/INPUT_TESTING.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -I$(START_DIR)/INPUT_TESTING_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ESP32_ROOT)/hardware/esp32/$(ESP32_LIB_VERSION)/cores/esp32 -I$(ARDUINO_ESP32_ROOT)/hardware/esp32/$(ESP32_LIB_VERSION)/variants/esp32 -I$(ARDUINO_ESP32_ROOT)/tools/esptool_py -I$(ARDUINO_ESP32_ROOT)/tools/mkspiffs -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/SUPPOR~1/ARDUIN~2/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/shared/freertos/include -I$(START_DIR)/include
...
DEFINES_STANDARD = -DMODEL=INPUT_TESTING -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o INPUT_TESTING.o INPUT_TESTING_data.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o
...
%.o : $(START_DIR)/INPUT_TESTING_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/INPUT_TESTING_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/INPUT_TESTING_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/INPUT_TESTING_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


INPUT_TESTING.o : $(START_DIR)/INPUT_TESTING_ert_rtw/INPUT_TESTING.c
	$(CC) $(CFLAGS) -o "$@" "$<"


INPUT_TESTING_data.o : $(START_DIR)/INPUT_TESTING_ert_rtw/INPUT_TESTING_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
